...
contract UpgradableMSCAFactory is Ownable2Step {
    ...
    /// @notice Allow the factory to receive native tokens
     ...
     * for MSCA.
     */
    function _getAddress(bytes32 _sender, bytes32 _salt, address[] memory _plugins, bytes[] memory _pluginInstallData)
        internal
        view
        returns (address addr, bytes32 mixedSalt)
    {
