...
import {EIP1271_INVALID_SIGNATURE, EIP1271_VALID_SIGNATURE} from "../../../../../common/Constants.sol";
import {BaseWeightedMultisigModule} from "./BaseWeightedMultisigModule.sol";
...
/// @title Weighted Multisig Module That Supports Additional Webauthn Authentication
/// @author Circle
/// @notice This module adds a weighted threshold ownership scheme to a ERC6900 smart contract account.
contract WeightedWebauthnMultisigModule is BaseWeightedMultisigModule, BaseERC712CompliantModule {
    ...
    string public constant MODULE_ID = "circle.weighted-webauthn-multisig-module.2.0.0";
    bytes32 private constant _HASHED_MODULE_ID = keccak256(bytes(MODULE_ID));
    bytes32 private constant _MULTISIG_MODULE_TYPEHASH =
        keccak256("CircleWeightedWebauthnMultisigMessage(bytes message)");

    constructor(address entryPoint) BaseWeightedMultisigModule(entryPoint) {}
    ...
    /// @inheritdoc BaseWeightedMultisigModule
    ...
    /// @param data bytes array to be decoded and used by the module to setup initial module data for the modular
    /// account. Format:
    ...
    function _getModuleTypeHash() internal pure override returns (bytes32) {
        return _MULTISIG_MODULE_TYPEHASH;
    }
