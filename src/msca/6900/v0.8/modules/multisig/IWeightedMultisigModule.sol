...
/// Module](https://github.com/alchemyplatform/multisig-module).
interface IWeightedMultisigModule {
    ...
    /// This function is installed on the account as part of module installation, and should only be called from an
    /// account.
    ...
    /// owners.
    /// This function is installed on the account as part of module installation, and should
