...
import {SIG_VALIDATION_SUCCEEDED, PLUGIN_AUTHOR, PLUGIN_VERSION_1} from "../../../../src/common/Constants.sol";
 ...
 */
contract TestTokenPlugin is BasePlugin {
    ...
    enum FunctionId {
        PRE_USER_OP_VALIDATION_HOOK_PASS1, // 0
        PRE_USER_OP_VALIDATION_HOOK_PASS2, // 1
        USER_OP_VALIDATION, // 2
        PRE_RUNTIME_VALIDATION_HOOK_PASS1, // 3
        PRE_RUNTIME_VALIDATION_HOOK_PASS2, // 4
        RUNTIME_VALIDATION, // 5
        PRE_EXECUTION_HOOK, // 6
        POST_EXECUTION_HOOK, // 7
        PRE_PERMITTED_CALL_EXECUTION_HOOK, // 8
        POST_PERMITTED_CALL_EXECUTION_HOOK // 9
    ...
    function pluginManifest() external pure override returns (PluginManifest memory) {
        ...
        /// executionHooks
        manifest.executionHooks = new ManifestExecutionHook[](5);
        ...
        manifest.executionHooks[3] = ManifestExecutionHook({
            selector: ISingleOwnerPlugin.getOwnerOf.selector,
            preExecHook: ManifestFunction({
                functionType: ManifestAssociatedFunctionType.SELF,
                functionId: uint8(FunctionId.PRE_EXECUTION_HOOK),
                dependencyIndex: 0
